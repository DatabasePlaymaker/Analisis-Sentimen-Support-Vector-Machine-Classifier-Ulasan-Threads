# -*- coding: utf-8 -*-
"""Analisis Sentimen - [SVM] - Ulasan Threads  - 2Label.ipynb
...
df = pd.read_csv("/content/drive/MyDrive/Dataset Ulasan Google Play/scrapped_data_Threads_1.csv")
df.head()
...
# df['steamming'].to_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_steamming_Threads_1.csv', index = False)

df_steamming = pd.read_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_steamming_Threads_1.csv', encoding = 'latin1')
df_steamming
...
# df_values.to_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_terjemahan_Threads_1.csv')

# Load Dataset Hasil Translate

df_values = pd.read_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_terjemahan_Threads_1.csv', index_col=0)
df_values
...
show_bar_chart(labels, counts, "Distribusi Sentimen Ulasan Aplikasi Threads")
...
show_pie_chart(labels, counts, "Distribusi Sentimen Ulasan Aplikasi Threads")
